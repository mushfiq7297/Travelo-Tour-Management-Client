    ...
    <div className="navbar fixed px-4 z-10 shadow-lg top-0 bg-indigo-950 text-white animate__animated animate__slideInDown font-stack">
      <div className="navbar-start">
        <div className="dropdown">
          ...
          <ul
            tabIndex={0}
            className="menu menu-sm dropdown-content mt-2 z-[1] p-4 shadow    text-white text-sm bg-indigo-500 rounded-b-lg"
          >
            {navLinks}
          </ul>
        </div>
        <a className="font-bold text-2xl">
          <div className="flex gap-2">
            <img
              src="/src/assets/touristsSpot/logo.png"
              className="w-12 h-12 rounded-full"
              alt=""
            />
            <h2 className="text-2xl my-2  lg:text-3xl">Travelo</h2>
          </div>
        </a>
      </div>
